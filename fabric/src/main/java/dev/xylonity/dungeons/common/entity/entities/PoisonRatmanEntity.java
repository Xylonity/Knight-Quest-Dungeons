package dev.xylonity.dungeons.common.entity.entities;
...
public class PoisonRatmanEntity extends Skeleton implements GeoEntity {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    private final Level serverWorld;
    private boolean summoned = false;
    private int counter = 0;
    private int arrowRotation = 50;
    private static final EntityDataAccessor<Boolean> ATTACK1 = SynchedEntityData.defineId(PoisonRatmanEntity.class, EntityDataSerializers.BOOLEAN);

    public PoisonRatmanEntity(EntityType<? extends Skeleton> pEntityType, Level pLevel) {
